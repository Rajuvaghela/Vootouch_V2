...
import com.lujayn.wootouch.adapter.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    private RelativeLayout rl_drTop;
    SessionManager manager;
    String color_back,color_tool_icon;
    String image;
    ImageView imageView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rl_drTop = (RelativeLayout)layout.findViewById(R.id.nav_header_container);
        imageView = (ImageView)layout.findViewById(R.id.ivProflepicture);
        ...
        image = settingOption.getData().getOptions().getSplash_screen();
        ...
        rl_drTop.setBackgroundColor(Color.parseColor(color_back));
    ...
    private void setLogo() {
        ...
        AppDebugLog.println("image= "+image);
   ...
   /*     Picasso.with(getActivity())
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout, final Toolbar toolbar) {
        ...
        mDrawerToggle.getDrawerArrowDrawable().setColor(Color.parseColor(color_tool_icon));
