...
/**
 * Created by Shailesh on 13/03/18.
 */

public class AnimCircleImageView extends AppCompatImageView {
    ...
    public AnimCircleImageView(Context context, AttributeSet attrs, int defStyle) {
